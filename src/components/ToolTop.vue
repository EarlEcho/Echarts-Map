...
<template>
    <div class="data-header-box">
        ...
        <div class="action-group g-rt">
            <el-button icon="icon iconfont icon-fangda" @click="showDialog = true"></el-button>
        ...
        <div class="popup-table">
            <div class="expand-dialog">
                <el-dialog :visible.sync="showDialog" width="75%" top="12vh" :modal="false">
                    <div class="content-wrapper">
                        ...
                        <div class="select-group-wrapper">
                            ...
                            <el-button @click="showDialog = true" size="small">搜索</el-button>
                        </div>
